...
<hr />
<?php
$request = 'http://apis.daum.net/search/image?apikey='.$apikey.'&q='.urlencode('bnb');
      ...
      <div class="row">
        ...
        <div class="col-md-2" style="height:300px;">
            ...
            <div class="panel panel-warning">
                ...
                <div class="panel-body">
                    <p><?php echo sprintf("<a href=\"%s\" target=\"_blank\"><img src=\"%s\" /></a>", $value->link, $value->thumbnail); ?></p>
                    <p><a class="btn btn-default" href="<?php echo $value->link; ?>" role="button" target="_blank">View details &raquo;</a></p>
                </div>
            </div>
        </div>
